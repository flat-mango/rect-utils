/* FlatMango.Utils.Rect.RectExtensions.cs
 * 
...
namespace FlatMango.Core.Utils.Rect
{
    ...
    public static class RectExtensions
    {
        ...
        public static Rect Scale(this Rect rect, float w, float h, float px, float py)
        {
        ...
        /// <param name="px">x component of scaling pivot.</param>
        /// <param name="py">y component of scaling pivot.</param>
        public static Rect Scale(this Rect rect, Vector2 scale, float px, float py)
        {
        ...
        /// <param name="w">Width scale.</param>
        /// <param name="h">Height scale.</param>
        public static Rect Scale(this Rect rect, float w, float h, Vector2 pivot)
        {
            float width  = rect.width * w;
            float height = rect.height * h;
        ...
        /// </summary>
        public static Rect Offset(this Rect rect, float right, float left, float top, float bottom)
        {
            rect.x += left;
            rect.y += top;
        ...
        /// </summary>
        public static Rect Offset(this Rect rect, RectOffset offset)
        {
            rect.x += offset.left;
            rect.y += offset.top;
        ...
        public static Rect Offset(this Rect rect, float value)
        {
            rect.x += value;
            rect.y += value;
            rect.width  -= value * 2;
        ...
        /// </summary>
        public static Rect AlignRight(this Rect rect, float x)
        {
            rect.x = x - rect.width;
        ...
        /// </summary>
        public static Rect AlignRight(this Rect rect, Rect target)
        {
        ...
        /// </summary>
        public static Rect AlignLeft(this Rect rect, float x)
        {
            rect.x = x;
        ...
        /// </summary>
        public static Rect AlignLeft(this Rect rect, Rect target)
        {
            rect.x = target.x;
        ...
        /// </summary>
        public static Rect AlignTop(this Rect rect, float y)
        {
            rect.y = y;
        ...
        /// </summary>
        public static Rect AlignTop(this Rect rect, Rect target)
        {
            rect.y = target.y;
        ...
        /// </summary>
        public static Rect AlignBottom(this Rect rect, float y)
        {
            rect.y = y - rect.width;
        ...
        /// </summary>
        public static Rect AlignBottom(this Rect rect, Rect target)
        {
        ...
        /// </summary>
        public static Rect AlignCenter(this Rect rect, Vector2 positon)
        {
            rect.center = positon;
        ...
        /// </summary>
        public static Rect AlignCenter(this Rect rect, Rect target)
        {
        ...
        public static Rect Align(this Rect rect, float px, float py, float x, float y)
        {
        ...
        /// <param name="x">x component of position to align to.</param>
        /// <param name="y">y component of position to alight to.</param>
        public static Rect Align(this Rect rect, Vector2 pivot, float x, float y)
        {
        ...
        /// <param name="px">x component of the pivot.</param>
        /// <param name="py">y component of the pivot.</param>
        public static Rect Align(this Rect rect, float px, float py, Vector2 position)
        {
        ...
        public static Rect Align(this Rect rect, Vector2 pivot, Vector2 position)
        {
        ...
        /// </summary>
        public static Rect Clamp(this Rect rect, Rect bounds)
        {
